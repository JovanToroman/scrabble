...
var G__44291 = cljs.core.PersistentArrayMap.EMPTY;
var G__44292 = native_stack_trace;
var G__44293 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ua-product","ua-product",938384227),new cljs.core.Keyword(null,"chrome","chrome",1718738387)], null);
var G__44294 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"asset-root","asset-root",1771735072),""], null);
return (cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4 ? cljs.stacktrace.parse_stacktrace.cljs$core$IFn$_invoke$arity$4(G__44291,G__44292,G__44293,G__44294) : cljs.stacktrace.parse_stacktrace.call(null,G__44291,G__44292,G__44293,G__44294));
});
...
var file = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44300__$1,new cljs.core.Keyword(null,"file","file",-1269645878));
var line = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44300__$1,new cljs.core.Keyword(null,"line","line",212345235));
var column = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44300__$1,new cljs.core.Keyword(null,"column","column",2078222095));
return devtools.hints.make_sense_of_the_error(error.message,file,line,column);
}catch (e44295){var _e = e44295;
return false;
}});
devtools.hints.type_error_to_string = (function devtools$hints$type_error_to_string(self){
var temp__5733__auto___44353 = devtools.hints.get_processed_errors_BANG_();
if(cljs.core.truth_(temp__5733__auto___44353)){
var seen_errors_44354 = temp__5733__auto___44353;
if(cljs.core.truth_(seen_errors_44354.has(self))){
} else {
seen_errors_44354.add(self);

var temp__5735__auto___44357 = devtools.hints.error_object_sense(self);
if(cljs.core.truth_(temp__5735__auto___44357)){
var sense_44364 = temp__5735__auto___44357;
self.message = [cljs.core.str.cljs$core$IFn$_invoke$arity$1(self.message),", a sanity hint:\n",cljs.core.str.cljs$core$IFn$_invoke$arity$1(sense_44364)].join('');
} else {
}
}
} else {
