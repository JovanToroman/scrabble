 ...
 *   lookup refs.
 */
com.fulcrologic.fulcro.algorithms.denormalize.follow_ref = (function com$fulcrologic$fulcro$algorithms$denormalize$follow_ref(state_map,p__56870){
var vec__56871 = p__56870;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56871,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56871,(1),null);
var ref = vec__56871;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.ref_key = (function com$fulcrologic$fulcro$algorithms$denormalize$ref_key(p__56884){
var vec__56885 = p__56884;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56885,(0),null);
var id = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56885,(1),null);
var ref = vec__56885;
if(cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"_","_",-1201019570,null),id)){
return table;
} else {
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (n,p__56893){
...
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56895__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
com.fulcrologic.fulcro.algorithms.denormalize.add_join_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_join_BANG_(n,p__56913,entity,state_map,parent_node,idents_seen){
...
var join_node = map__56914__$1;
var query = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56914__$1,new cljs.core.Keyword(null,"query","query",-1288509510));
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56914__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
...
});})(link_join_QMARK_,v,key__$1,is_ref_QMARK_,join_entity,to_many_QMARK_,depth_based_QMARK_,recursive_QMARK_,stop_recursion_QMARK_,parent_node__$1,target_node,idents_seen__$1,map__56914,map__56914__$1,join_node,query,key))
),join_entity));
} else {
...
var join_node_index = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (link_join_QMARK_,v,key__$1,is_ref_QMARK_,join_entity,to_many_QMARK_,depth_based_QMARK_,recursive_QMARK_,stop_recursion_QMARK_,parent_node__$1,target_node,idents_seen__$1,map__56914,map__56914__$1,join_node,query,key){
...
com.fulcrologic.fulcro.algorithms.denormalize.add_union_BANG_ = (function com$fulcrologic$fulcro$algorithms$denormalize$add_union_BANG_(n,p__56933,entity,state_map,idents_seen){
var map__56941 = p__56933;
...
var join_node = map__56941__$1;
var key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56941__$1,new cljs.core.Keyword(null,"key","key",-1516042587));
var link_join_QMARK_ = com.fulcrologic.fulcro.algorithms.denormalize.lookup_ref_QMARK_(key);
...
var union_key__GT_query = cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (link_join_QMARK_,v,union_node,map__56941,map__56941__$1,join_node,key){
return (function (result,p__56943){
var map__56945 = p__56943;
...
var node = map__56945__$1;
var union_key = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56945__$1,new cljs.core.Keyword(null,"union-key","union-key",1529707234));
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(result,union_key,node);
});})(link_join_QMARK_,v,union_node,map__56941,map__56941__$1,join_node,key))
...
if(to_many_QMARK_){
return cljs.core.assoc_BANG_.cljs$core$IFn$_invoke$arity$3(n,key,cljs.core.into.cljs$core$IFn$_invoke$arity$3(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$1(((function (link_join_QMARK_,v,union_node,union_key__GT_query,is_ref_QMARK_,to_many_QMARK_,map__56941,map__56941__$1,join_node,key){
...
var vec__56965 = lookup_ref;
var table = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__56965,(0),null);
...
});})(link_join_QMARK_,v,union_node,union_key__GT_query,is_ref_QMARK_,to_many_QMARK_,map__56941,map__56941__$1,join_node,key))
),v));
} else {
if(is_ref_QMARK_){
...
if(cljs.core.truth_(temp__5733__auto__)){
var e = temp__5733__auto__;
var temp__5733__auto____$1 = (function (){var G__56968 = cljs.core.first(v);
return (union_key__GT_query.cljs$core$IFn$_invoke$arity$1 ? union_key__GT_query.cljs$core$IFn$_invoke$arity$1(G__56968) : union_key__GT_query.call(null,G__56968));
})();
if(cljs.core.truth_(temp__5733__auto____$1)){
var target_ast_node = temp__5733__auto____$1;
 ...
 */
com.fulcrologic.fulcro.algorithms.denormalize.denormalize = (function com$fulcrologic$fulcro$algorithms$denormalize$denormalize(p__56973,current_entity,state_map,idents_seen){
...
var top_node = map__56974__$1;
var type = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56974__$1,new cljs.core.Keyword(null,"type","type",1174270348));
var children = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56974__$1,new cljs.core.Keyword(null,"children","children",-940561982));
...
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(new cljs.core.Symbol(null,"*","*",345799209,null),(function (){var G__56976 = nil_nodes;
var G__56976__$1 = (((G__56976 == null))?null:cljs.core.first(G__56976));
if((G__56976__$1 == null)){
return null;
} else {
return new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(G__56976__$1);
}
})());
} else {
return and__4120__auto__;
...
var G__56977 = result_node__$1;
var G__56977__$1 = (((G__56977 == null))?null:cljs.core.persistent_BANG_(G__56977));
if((G__56977__$1 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__56977__$1,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
var G__56978 = com.fulcrologic.fulcro.algorithms.denormalize.denormalize(ast,starting_entity,state_map,cljs.core.PersistentArrayMap.EMPTY);
if((G__56978 == null)){
return null;
} else {
return com.fulcrologic.fulcro.algorithms.denormalize.with_time(G__56978,com.fulcrologic.fulcro.algorithms.denormalize._STAR_denormalize_time_STAR_);
}
});
/**
...
var G__56980 = props;
var G__56980__$1 = (((G__56980 == null))?null:cljs.core.meta(G__56980));
if((G__56980__$1 == null)){
return null;
} else {
return new cljs.core.Keyword("com.fulcrologic.fulcro.algorithms.denormalize","time","com.fulcrologic.fulcro.algorithms.denormalize/time",-375164969).cljs$core$IFn$_invoke$arity$1(G__56980__$1);
}
});
