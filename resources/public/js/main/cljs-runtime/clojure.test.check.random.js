...
var G__47017 = z;
if(((24) > (function (){var G__47037 = clojure.test.check.random.bxoubsr(z,(1));
return (clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1 ? clojure.test.check.random.longs.bit_count.cljs$core$IFn$_invoke$arity$1(G__47037) : clojure.test.check.random.longs.bit_count.call(null,G__47037));
})())){
return clojure.test.check.random.longs.bit_xor(G__47017,clojure.test.check.random.mix_gamma_const_3);
} else {
return G__47017;
}
});
...
var G__47137 = state_SINGLEQUOTE__SINGLEQUOTE_;
var G__47138 = cljs.core.conj_BANG_.cljs$core$IFn$_invoke$arity$2(ret,new_rng);
state__$1 = G__47137;
ret = G__47138;
continue;
}
...
var state = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__47067__$1,new cljs.core.Keyword(null,"state","state",-1988618099));
var vec__47072 = clojure.test.check.random.split(state);
var r1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47072,(0),null);
var r2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47072,(1),null);
