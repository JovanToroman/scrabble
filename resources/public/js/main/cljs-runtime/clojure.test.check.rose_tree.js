...
return cljs.core.cons(cljs.core.first(s),(function (){var G__46996 = (n - (1));
var G__46997 = cljs.core.rest(s);
return (clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.exclude_nth.cljs$core$IFn$_invoke$arity$2(G__46996,G__46997) : clojure.test.check.rose_tree.exclude_nth.call(null,G__46996,G__46997));
})());
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose((function (){var G__47010 = clojure.test.check.rose_tree.root(rose);
return (f.cljs$core$IFn$_invoke$arity$1 ? f.cljs$core$IFn$_invoke$arity$1(G__47010) : f.call(null,G__47010));
})(),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__47005_SHARP_){
return (clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.fmap.cljs$core$IFn$_invoke$arity$2(f,p1__47005_SHARP_) : clojure.test.check.rose_tree.fmap.call(null,f,p1__47005_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(clojure.test.check.rose_tree.root(rose),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__47015_SHARP_){
return (clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.filter.cljs$core$IFn$_invoke$arity$2(pred,p1__47015_SHARP_) : clojure.test.check.rose_tree.filter.call(null,pred,p1__47015_SHARP_));
}),cljs.core.filter.cljs$core$IFn$_invoke$arity$2((function (p1__47016_SHARP_){
var G__47071 = clojure.test.check.rose_tree.root(p1__47016_SHARP_);
return (pred.cljs$core$IFn$_invoke$arity$1 ? pred.cljs$core$IFn$_invoke$arity$1(G__47071) : pred.call(null,G__47071));
}),clojure.test.check.rose_tree.children(rose))));
});
/**
...
var iter__4523__auto__ = (function clojure$test$check$rose_tree$permutations_$_iter__47079(s__47080){
return (new cljs.core.LazySeq(null,(function (){
var s__47080__$1 = s__47080;
while(true){
var temp__5735__auto__ = cljs.core.seq(s__47080__$1);
if(temp__5735__auto__){
var xs__6292__auto__ = temp__5735__auto__;
var vec__47094 = cljs.core.first(xs__6292__auto__);
var rose = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47094,(0),null);
var index = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__47094,(1),null);
var iterys__4519__auto__ = ((function (s__47080__$1,vec__47094,rose,index,xs__6292__auto__,temp__5735__auto__){
return (function clojure$test$check$rose_tree$permutations_$_iter__47079_$_iter__47081(s__47082){
return (new cljs.core.LazySeq(null,((function (s__47080__$1,vec__47094,rose,index,xs__6292__auto__,temp__5735__auto__){
return (function (){
var s__47082__$1 = s__47082;
while(true){
var temp__5735__auto____$1 = cljs.core.seq(s__47082__$1);
if(temp__5735__auto____$1){
var s__47082__$2 = temp__5735__auto____$1;
if(cljs.core.chunked_seq_QMARK_(s__47082__$2)){
var c__4521__auto__ = cljs.core.chunk_first(s__47082__$2);
var size__4522__auto__ = cljs.core.count(c__4521__auto__);
var b__47084 = cljs.core.chunk_buffer(size__4522__auto__);
if((function (){var i__47083 = (0);
while(true){
if((i__47083 < size__4522__auto__)){
var child = cljs.core._nth.cljs$core$IFn$_invoke$arity$2(c__4521__auto__,i__47083);
cljs.core.chunk_append(b__47084,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child));

var G__47169 = (i__47083 + (1));
i__47083 = G__47169;
continue;
} else {
return true;
...
return cljs.core.chunk_cons(cljs.core.chunk(b__47084),clojure$test$check$rose_tree$permutations_$_iter__47079_$_iter__47081(cljs.core.chunk_rest(s__47082__$2)));
} else {
return cljs.core.chunk_cons(cljs.core.chunk(b__47084),null);
}
} else {
var child = cljs.core.first(s__47082__$2);
return cljs.core.cons(cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(roses,index,child),clojure$test$check$rose_tree$permutations_$_iter__47079_$_iter__47081(cljs.core.rest(s__47082__$2)));
}
} else {
return null;
}
...
});})(s__47080__$1,vec__47094,rose,index,xs__6292__auto__,temp__5735__auto__))
,null,null));
});})(s__47080__$1,vec__47094,rose,index,xs__6292__auto__,temp__5735__auto__))
;
var fs__4520__auto__ = cljs.core.seq(iterys__4519__auto__(clojure.test.check.rose_tree.children(rose)));
if(fs__4520__auto__){
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(fs__4520__auto__,clojure$test$check$rose_tree$permutations_$_iter__47079(cljs.core.rest(s__47080__$1)));
} else {
var G__47176 = cljs.core.rest(s__47080__$1);
s__47080__$1 = G__47176;
continue;
}
} else {
return null;
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__47105_SHARP_){
return (clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.zip.cljs$core$IFn$_invoke$arity$2(f,p1__47105_SHARP_) : clojure.test.check.rose_tree.zip.call(null,f,p1__47105_SHARP_));
...
return clojure.test.check.rose_tree.make_rose(cljs.core.apply.cljs$core$IFn$_invoke$arity$2(f,cljs.core.map.cljs$core$IFn$_invoke$arity$2(clojure.test.check.rose_tree.root,roses)),cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__47110_SHARP_){
return (clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink.cljs$core$IFn$_invoke$arity$2(f,p1__47110_SHARP_) : clojure.test.check.rose_tree.shrink.call(null,f,p1__47110_SHARP_));
...
return (function (){
return cljs.core.cons((function (){var G__47118 = f;
var G__47119 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$3(roses,(0),left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__47118,G__47119) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__47118,G__47119));
})(),(new cljs.core.LazySeq(null,((function (left_count){
return (function (){
return (new cljs.core.List(null,(function (){var G__47122 = f;
var G__47123 = cljs.core.subvec.cljs$core$IFn$_invoke$arity$2(roses,left_count);
return (clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2 ? clojure.test.check.rose_tree.shrink_vector_STAR_.cljs$core$IFn$_invoke$arity$2(G__47122,G__47123) : clojure.test.check.rose_tree.shrink_vector_STAR_.call(null,G__47122,G__47123));
})(),null,(1),null));
});})(left_count))
,null,null)));
});})(left_count))
