...
var o__43637__auto___46150 = (function (){var o__43637__auto__ = (function (){var o__43637__auto__ = Promise;
return (o__43637__auto__["resolve"]).call(o__43637__auto__);
})();
return (o__43637__auto__["then"]).call(o__43637__auto__,callback);
})();
(o__43637__auto___46150["catch"]).call(o__43637__auto___46150,devtools.async.rethrow_outside_promise);
...
var G__46132_46151 = Error;
var target__43642__auto___46152 = G__46132_46151;
if(cljs.core.truth_(target__43642__auto___46152)){
} else {
throw (new Error(["Assert failed: ",["unable to locate object path ",null," in ",cljs.core.str.cljs$core$IFn$_invoke$arity$1(G__46132_46151)].join(''),"\n","target__43642__auto__"].join('')));
}

(target__43642__auto___46152["stackTraceLimit"] = Infinity);
