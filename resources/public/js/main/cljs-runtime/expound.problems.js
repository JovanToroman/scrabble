...
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(displayed_form,new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k)),(function (){var G__56347 = show_valid_values_QMARK_;
var G__56348 = new cljs.core.Keyword(null,"key","key",-1516042587).cljs$core$IFn$_invoke$arity$1(k);
var G__56349 = rst__$1;
return (expound.problems.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.problems.summary_form.cljs$core$IFn$_invoke$arity$3(G__56347,G__56348,G__56349) : expound.problems.summary_form.call(null,G__56347,G__56348,G__56349));
})(),new cljs.core.Keyword("expound.problems","irrelevant","expound.problems/irrelevant",2090226124));
} else {
if(((cljs.core.map_QMARK_(form)) && (expound.paths.kvps_QMARK_(k)))){
var G__56499 = show_valid_values_QMARK_;
var G__56500 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),new cljs.core.Keyword(null,"idx","idx",1053688473).cljs$core$IFn$_invoke$arity$1(k));
var G__56501 = rst__$1;
show_valid_values_QMARK_ = G__56499;
form = G__56500;
in$ = G__56501;
continue;
} else {
if(cljs.core.associative_QMARK_(form)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(displayed_form,k,(function (){var G__56350 = show_valid_values_QMARK_;
var G__56351 = cljs.core.get.cljs$core$IFn$_invoke$arity$2(form,k);
var G__56352 = rst__$1;
return (expound.problems.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.problems.summary_form.cljs$core$IFn$_invoke$arity$3(G__56350,G__56351,G__56352) : expound.problems.summary_form.call(null,G__56350,G__56351,G__56352));
})());
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.seq_QMARK_(form)))){
return cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.list,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__56353 = show_valid_values_QMARK_;
var G__56354 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(form,k);
var G__56355 = rst__$1;
return (expound.problems.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.problems.summary_form.cljs$core$IFn$_invoke$arity$3(G__56353,G__56354,G__56355) : expound.problems.summary_form.call(null,G__56353,G__56354,G__56355));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.set_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentHashSet.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__56361 = show_valid_values_QMARK_;
var G__56362 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__56363 = rst__$1;
return (expound.problems.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.problems.summary_form.cljs$core$IFn$_invoke$arity$3(G__56361,G__56362,G__56363) : expound.problems.summary_form.call(null,G__56361,G__56362,G__56363));
})()));
} else {
if(((cljs.core.int_QMARK_(k)) && (cljs.core.list_QMARK_(form)))){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.List.EMPTY,cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(cljs.core.vec(displayed_form),k,(function (){var G__56404 = show_valid_values_QMARK_;
var G__56405 = cljs.core.nth.cljs$core$IFn$_invoke$arity$2(cljs.core.seq(form),k);
var G__56406 = rst__$1;
return (expound.problems.summary_form.cljs$core$IFn$_invoke$arity$3 ? expound.problems.summary_form.cljs$core$IFn$_invoke$arity$3(G__56404,G__56405,G__56406) : expound.problems.summary_form.call(null,G__56404,G__56405,G__56406));
})()));
} else {
...
var max_width = cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.max,cljs.core.map.cljs$core$IFn$_invoke$arity$2((function (p1__56409_SHARP_){
return cljs.core.count(cljs.core.str.cljs$core$IFn$_invoke$arity$1(p1__56409_SHARP_));
...
var G__56422 = cljs.core.first(new cljs.core.Keyword(null,"path","path",-188191168).cljs$core$IFn$_invoke$arity$1(problem));
var fexpr__56421 = new cljs.core.PersistentHashSet(null, new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"ret","ret",-468222814),null], null), null);
return (fexpr__56421.cljs$core$IFn$_invoke$arity$1 ? fexpr__56421.cljs$core$IFn$_invoke$arity$1(G__56422) : fexpr__56421.call(null,G__56422));
}
...
var map__56455 = problem;
var map__56455__$1 = (((((!((map__56455 == null))))?(((((map__56455.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__56455.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__56455):map__56455);
var form = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56455__$1,new cljs.core.Keyword("expound","form","expound/form",-264680632));
var in$ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56455__$1,new cljs.core.Keyword("expound","in","expound/in",-1900412298));
var map__56456 = opts;
...
var show_valid_values_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__56456__$1,new cljs.core.Keyword(null,"show-valid-values?","show-valid-values?",-587258094),false);
...
var s = (function (){var _STAR_print_namespace_maps_STAR__orig_val__56462 = cljs.core._STAR_print_namespace_maps_STAR_;
var _STAR_print_namespace_maps_STAR__temp_val__56463 = false;
cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__temp_val__56463;
...
}finally {cljs.core._STAR_print_namespace_maps_STAR_ = _STAR_print_namespace_maps_STAR__orig_val__56462;
}})();
var vec__56457 = cljs.core.re_find(regex,s);
...
var line = first__56459;
var first__56459__$1 = cljs.core.first(seq__56458__$1);
var seq__56458__$2 = cljs.core.next(seq__56458__$1);
var prefix = first__56459__$1;
var _more = seq__56458__$2;
...
var problems = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56472__$1,new cljs.core.Keyword("cljs.spec.alpha","problems","cljs.spec.alpha/problems",447400814));
var value = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56472__$1,new cljs.core.Keyword("cljs.spec.alpha","value","cljs.spec.alpha/value",1974786274));
var args = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56472__$1,new cljs.core.Keyword("cljs.spec.alpha","args","cljs.spec.alpha/args",1870769783));
var ret = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56472__$1,new cljs.core.Keyword("cljs.spec.alpha","ret","cljs.spec.alpha/ret",1165997503));
var fn = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56472__$1,new cljs.core.Keyword("cljs.spec.alpha","fn","cljs.spec.alpha/fn",408600443));
var failure = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56472__$1,new cljs.core.Keyword("cljs.spec.alpha","failure","cljs.spec.alpha/failure",188258592));
var spec = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__56472__$1,new cljs.core.Keyword("cljs.spec.alpha","spec","cljs.spec.alpha/spec",1947137578));
...
var problems_SINGLEQUOTE_ = cljs.core.map.cljs$core$IFn$_invoke$arity$2(cljs.core.comp.cljs$core$IFn$_invoke$arity$variadic(cljs.core.partial.cljs$core$IFn$_invoke$arity$2(expound.problems.adjust_in,form),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(expound.problems.adjust_path,failure),cljs.core.partial.cljs$core$IFn$_invoke$arity$2(expound.problems.add_spec,spec),cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([cljs.core.partial.cljs$core$IFn$_invoke$arity$2(expound.problems.fix_via,spec),((function (map__56472,map__56472__$1,problems,value,args,ret,fn,failure,spec,caller,form){
return (function (p1__56469_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__56469_SHARP_,new cljs.core.Keyword("expound","form","expound/form",-264680632),form);
});})(map__56472,map__56472__$1,problems,value,args,ret,fn,failure,spec,caller,form))
,((function (map__56472,map__56472__$1,problems,value,args,ret,fn,failure,spec,caller,form){
return (function (p1__56470_SHARP_){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(p1__56470_SHARP_,new cljs.core.Keyword("expound.spec.problem","type","expound.spec.problem/type",-862044659),expound.problems.ptype(failure,p1__56470_SHARP_));
});})(map__56472,map__56472__$1,problems,value,args,ret,fn,failure,spec,caller,form))
], 0)),problems);
