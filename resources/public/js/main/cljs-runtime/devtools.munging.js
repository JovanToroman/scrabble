...
var o44379 = temp__5733__auto__;
var temp__5733__auto____$1 = (o44379["core"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o44380 = temp__5733__auto____$1;
return (o44380["js_reserved_QMARK_"]);
} else {
return null;
}
} else {
...
var o__43637__auto__ = f;
return (o__43637__auto__["toString"]).call(o__43637__auto__);
} else {
return "";
}
}catch (e44381){var _ = e44381;
return "";
}});
...
try{var o__43637__auto___44541 = t;
(o__43637__auto___44541["cljs$lang$ctorPrWriter"]).call(o__43637__auto___44541,t,writer);
}catch (e44385){var __44542 = e44385;
}
...
var char_code = (function (){var o__43637__auto__ = (new String(char$));
return (o__43637__auto__["charCodeAt"]).call(o__43637__auto__,(0));
})();
var num_code = (char_code - (48));
var subscript_code = ((8320) + num_code);
var o__43637__auto__ = String;
return (o__43637__auto__["fromCharCode"]).call(o__43637__auto__,subscript_code);
});
/**
...
var num_code = (char_code - (48));
var superscript_code = (function (){var G__44386 = num_code;
switch (G__44386) {
case (1):
return (185);
...
var o__43637__auto__ = String;
return (o__43637__auto__["fromCharCode"]).call(o__43637__auto__,superscript_code);
});
/**
...
}catch (e44394){var _e__43644__auto__ = e44394;
return false;
}})())){
...
var vec__44397 = devtools.munging.parse_fn_source(fn_source);
var name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44397,(0),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var o44404 = temp__5733__auto__;
var temp__5733__auto____$1 = (o44404["dependencies_"]);
if(cljs.core.truth_(temp__5733__auto____$1)){
var o44405 = temp__5733__auto____$1;
return (o44405["nameToPath"]);
} else {
return null;
}
} else {
...
devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic = (function (tokens,p__44408){
var vec__44409 = p__44408;
var ns_detector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44409,(0),null);
...
var G__44567 = cljs.core.concat.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.last(remaining_tokens)], null),name_tokens);
var G__44568 = cljs.core.butlast(remaining_tokens);
name_tokens = G__44567;
remaining_tokens = G__44568;
continue;
}
}
break;
...
/** @this {Function} */
devtools.munging.detect_namespace_prefix.cljs$lang$applyTo = (function (seq44406){
var G__44407 = cljs.core.first(seq44406);
var seq44406__$1 = cljs.core.next(seq44406);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44407,seq44406__$1);
});
...
var vec__44414 = cljs.core.split_with((function (p1__44413_SHARP_){
return cljs.core.not_EQ_.cljs$core$IFn$_invoke$arity$2(p1__44413_SHARP_,"arity");
}),tokens);
var prefix_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44414,(0),null);
var arity_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44414,(1),null);
...
var vec__44420 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(remaining_tokens,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([detector], 0));
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44420,(0),null);
var name_and_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44420,(1),null);
if(cljs.core.empty_QMARK_(protocol_ns)){
var G__44577 = cljs.core.rest(remaining_tokens);
var G__44578 = cljs.core.conj.cljs$core$IFn$_invoke$arity$2(name_tokens,cljs.core.first(remaining_tokens));
remaining_tokens = G__44577;
name_tokens = G__44578;
continue;
} else {
...
var vec__44427 = devtools.munging.strip_arity(tokens);
var tokens__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44427,(0),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44427,(1),null);
var vec__44430 = devtools.munging.detect_namespace_prefix.cljs$core$IFn$_invoke$arity$variadic(tokens__$1,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([effective_detector], 0));
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44430,(0),null);
var tokens__$2 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44430,(1),null);
var vec__44433 = devtools.munging.parse_protocol(tokens__$2,effective_detector);
var fn_name_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44433,(0),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44433,(1),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44433,(2),null);
var protocol_method_tokens = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44433,(3),null);
...
var vec__44439 = result;
var munged_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44439,(0),null);
var munged_name__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44439,(1),null);
var munged_protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44439,(2),null);
var munged_protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44439,(3),null);
var munged_protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44439,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44439,(5),null);
...
if(cljs.core.truth_(temp__5733__auto__)){
var vec__44442 = temp__5733__auto__;
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44442,(0),null);
var args = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44442,(1),null);
var vec__44446 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$1(munged_name);
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44446,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44446,(1),null);
...
return cljs.core.concat.cljs$core$IFn$_invoke$arity$2(cljs.core.take.cljs$core$IFn$_invoke$arity$2((2),fn_info),cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),(function (){var G__44449 = cljs.core.second(cljs.core.first(arities));
return (devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1 ? devtools.munging.parse_fn_info_deep.cljs$core$IFn$_invoke$arity$1(G__44449) : devtools.munging.parse_fn_info_deep.call(null,G__44449));
})()));
}
} else {
return fn_info;
...
var G__44631 = (arity + (1));
var G__44632 = (function (){var temp__5733__auto__ = devtools.munging.get_fn_fixed_arity(f,arity);
if(cljs.core.truth_(temp__5733__auto__)){
...
devtools.munging.review_arity = (function devtools$munging$review_arity(p__44459){
var vec__44460 = p__44459;
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44460,(0),null);
var arity_fn = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44460,(1),null);
...
return cljs.core.get.cljs$core$IFn$_invoke$arity$2(arities,p1__44466_SHARP_);
});})(sorted_keys))
,sorted_keys);
...
return cljs.core.drop.cljs$core$IFn$_invoke$arity$2((2),p1__44467_SHARP_);
...
var args__4736__auto__ = [];
var len__4730__auto___44638 = arguments.length;
var i__4731__auto___44639 = (0);
while(true){
if((i__4731__auto___44639 < len__4730__auto___44638)){
args__4736__auto__.push((arguments[i__4731__auto___44639]));

var G__44640 = (i__4731__auto___44639 + (1));
i__4731__auto___44639 = G__44640;
continue;
} else {
}
break;
...
devtools.munging.arities_to_args_lists.cljs$core$IFn$_invoke$arity$variadic = (function (arities,p__44474){
var vec__44475 = p__44474;
var humanize_QMARK_ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44475,(0),null);
...
/** @this {Function} */
devtools.munging.arities_to_args_lists.cljs$lang$applyTo = (function (seq44469){
var G__44470 = cljs.core.first(seq44469);
var seq44469__$1 = cljs.core.next(seq44469);
var self__4717__auto__ = this;
return self__4717__auto__.cljs$core$IFn$_invoke$arity$variadic(G__44470,seq44469__$1);
});
...
var include_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44492__$1,new cljs.core.Keyword(null,"include-ns?","include-ns?",-341372810));
var include_protocol_ns_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44492__$1,new cljs.core.Keyword(null,"include-protocol-ns?","include-protocol-ns?",989250951));
var silence_common_protocols_QMARK_ = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44492__$1,new cljs.core.Keyword(null,"silence-common-protocols?","silence-common-protocols?",2012431893));
var ns_detector = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__44492__$1,new cljs.core.Keyword(null,"ns-detector","ns-detector",-2041592760));
var vec__44493 = devtools.munging.break_and_demunge_name.cljs$core$IFn$_invoke$arity$2(munged_name,ns_detector);
var fn_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44493,(0),null);
var fn_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44493,(1),null);
var protocol_ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44493,(2),null);
var protocol_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44493,(3),null);
var protocol_method = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44493,(4),null);
var arity = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44493,(5),null);
...
var o__43637__auto__ = f;
return (o__43637__auto__["getBasis"]).call(o__43637__auto__);
});
/**
...
}catch (e44500){var _e__43644__auto__ = e44500;
...
var G__44676 = (obj[cljs.core.first(path)]);
var G__44677 = cljs.core.rest(path);
obj = G__44676;
path = G__44677;
continue;
} else {
...
return (function (accum,p__44514){
var vec__44515 = p__44514;
var bit = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44515,(0),null);
var protocol = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44515,(1),null);
...
devtools.munging.convert_to_protocol_descriptor = (function devtools$munging$convert_to_protocol_descriptor(fast_QMARK_,p__44522){
var vec__44523 = p__44522;
var ns = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44523,(0),null);
var name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44523,(1),null);
var selector = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44523,(2),null);
...
var munged_name = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44533,(0),null);
var matches__$1 = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__44533,(1),null);
...
var sorted_fns = cljs.core.map.cljs$core$IFn$_invoke$arity$2(((function (name,sorted_matches,vec__44533,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator){
return (function (p1__44529_SHARP_){
return (obj[cljs.core.first(p1__44529_SHARP_)]);
});})(name,sorted_matches,vec__44533,munged_name,matches__$1,key_prefix,pattern,all_keys,matches,methods$,match_to_arity,match_arity_comparator))
,sorted_matches);
