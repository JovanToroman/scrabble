...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (adds,p__49494){
var vec__49495 = p__49494;
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49495,(0),null);
...
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3((function (rems,p__49503){
...
var vec__49508 = temp__5733__auto__;
var _ = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49508,(0),null);
var vb = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49508,(1),null);
...
return cljs.core.conj.cljs$core$IFn$_invoke$arity$2(rems,(function (){var G__49511 = k;
if(cljs.core.map_QMARK_(k)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__49511,new cljs.core.Keyword("fulcro.inspect.lib.diff","key?","fulcro.inspect.lib.diff/key?",325118813),true);
} else {
return G__49511;
}
})());
...
com.fulcrologic.fulcro.inspect.diff.patch_updates = (function com$fulcrologic$fulcro$inspect$diff$patch_updates(x,p__49514){
var map__49515 = p__49514;
var map__49515__$1 = (((((!((map__49515 == null))))?(((((map__49515.cljs$lang$protocol_mask$partition0$ & (64))) || ((cljs.core.PROTOCOL_SENTINEL === map__49515.cljs$core$ISeq$))))?true:false):false))?cljs.core.apply.cljs$core$IFn$_invoke$arity$2(cljs.core.hash_map,map__49515):map__49515);
var updates = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49515__$1,new cljs.core.Keyword("fulcro.inspect.lib.diff","updates","fulcro.inspect.lib.diff/updates",221795125));
...
com.fulcrologic.fulcro.inspect.diff.patch_removals = (function com$fulcrologic$fulcro$inspect$diff$patch_removals(x,p__49518){
var map__49520 = p__49518;
...
var removals = cljs.core.get.cljs$core$IFn$_invoke$arity$2(map__49520__$1,new cljs.core.Keyword("fulcro.inspect.lib.diff","removals","fulcro.inspect.lib.diff/removals",-1638817439));
return cljs.core.reduce.cljs$core$IFn$_invoke$arity$3(((function (map__49520,map__49520__$1,removals){
...
var vec__49524 = cljs.core.first(rem);
var k = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49524,(0),null);
var v = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__49524,(1),null);
return cljs.core.update.cljs$core$IFn$_invoke$arity$3(final$,k,((function (vec__49524,k,v,map__49520,map__49520__$1,removals){
return (function (p1__49517_SHARP_){
var G__49527 = p1__49517_SHARP_;
var G__49528 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword("fulcro.inspect.lib.diff","removals","fulcro.inspect.lib.diff/removals",-1638817439),v], null);
return (com.fulcrologic.fulcro.inspect.diff.patch_removals.cljs$core$IFn$_invoke$arity$2 ? com.fulcrologic.fulcro.inspect.diff.patch_removals.cljs$core$IFn$_invoke$arity$2(G__49527,G__49528) : com.fulcrologic.fulcro.inspect.diff.patch_removals.call(null,G__49527,G__49528));
});})(vec__49524,k,v,map__49520,map__49520__$1,removals))
);
} else {
...
});})(map__49520,map__49520__$1,removals))
,x,removals);
});
