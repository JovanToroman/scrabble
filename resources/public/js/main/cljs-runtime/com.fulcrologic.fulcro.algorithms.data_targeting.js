...
var len__4730__auto___58455 = arguments.length;
var i__4731__auto___58456 = (0);
while(true){
if((i__4731__auto___58456 < len__4730__auto___58455)){
args__4736__auto__.push((arguments[i__4731__auto___58456]));

var G__58460 = (i__4731__auto___58456 + (1));
i__4731__auto___58456 = G__58460;
continue;
} else {
}
break;
...
/** @this {Function} */
com.fulcrologic.fulcro.algorithms.data_targeting.multiple_targets.cljs$lang$applyTo = (function (seq58364){
var self__4718__auto__ = this;
return self__4718__auto__.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq(seq58364));
});
...
var args__4736__auto__ = [];
var len__4730__auto___58471 = arguments.length;
var i__4731__auto___58472 = (0);
while(true){
if((i__4731__auto___58472 < len__4730__auto___58471)){
args__4736__auto__.push((arguments[i__4731__auto___58472]));

var G__58473 = (i__4731__auto___58472 + (1));
i__4731__auto___58472 = G__58473;
continue;
} else {
}
break;
...
return (function (state__$1,p__58394){
var vec__58395 = p__58394;
var command = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58395,(0),null);
var data_path = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__58395,(1),null);
var already_has_ident_at_path_QMARK_ = ((function (vec__58395,command,data_path,actions){
return (function (data_path__$1){
return cljs.core.some(((function (vec__58395,command,data_path,actions){
return (function (p1__58381_SHARP_){
return cljs.core._EQ_.cljs$core$IFn$_invoke$arity$2(p1__58381_SHARP_,ident);
});})(vec__58395,command,data_path,actions))
,cljs.core.get_in.cljs$core$IFn$_invoke$arity$2(state__$1,data_path__$1));
});})(vec__58395,command,data_path,actions))
;
var G__58401 = command;
...
return cljs.core.update_in.cljs$core$IFn$_invoke$arity$3(state__$1,data_path,((function (G__58401,G__58401__$1,already_has_ident_at_path_QMARK_,vec__58395,command,data_path,actions){
return (function (p1__58383_SHARP_){
return cljs.core.into.cljs$core$IFn$_invoke$arity$2(new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [ident], null),p1__58383_SHARP_);
});})(G__58401,G__58401__$1,already_has_ident_at_path_QMARK_,vec__58395,command,data_path,actions))
);
}
...
taoensso.timbre._log_BANG_.cljs$core$IFn$_invoke$arity$10(taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"error","error",-978969032),"com.fulcrologic.fulcro.algorithms.data-targeting",null,93,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay(((function (path_to_vector,to_many_QMARK_,index,vector,G__58401,G__58401__$1,already_has_ident_at_path_QMARK_,vec__58395,command,data_path,actions){
return (function (){
...
});})(path_to_vector,to_many_QMARK_,index,vector,G__58401,G__58401__$1,already_has_ident_at_path_QMARK_,vec__58395,command,data_path,actions))
,null)),null,-2117478505);
}

if(to_many_QMARK_){
if((!(cljs.core.vector_QMARK_(vector)))){
taoensso.timbre._log_BANG_.cljs$core$IFn$_invoke$arity$10(taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"error","error",-978969032),"com.fulcrologic.fulcro.algorithms.data-targeting",null,96,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay(((function (path_to_vector,to_many_QMARK_,index,vector,G__58401,G__58401__$1,already_has_ident_at_path_QMARK_,vec__58395,command,data_path,actions){
return (function (){
...
taoensso.timbre._log_BANG_.cljs$core$IFn$_invoke$arity$10(taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"error","error",-978969032),"com.fulcrologic.fulcro.algorithms.data-targeting",null,97,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay(((function (path_to_vector,to_many_QMARK_,index,vector,G__58401,G__58401__$1,already_has_ident_at_path_QMARK_,vec__58395,command,data_path,actions){
return (function (){
...
taoensso.timbre._log_BANG_.cljs$core$IFn$_invoke$arity$10(taoensso.timbre._STAR_config_STAR_,new cljs.core.Keyword(null,"error","error",-978969032),"com.fulcrologic.fulcro.algorithms.data-targeting",null,98,new cljs.core.Keyword(null,"p","p",151049309),new cljs.core.Keyword(null,"auto","auto",-566279492),(new cljs.core.Delay(((function (path_to_vector,to_many_QMARK_,index,vector,G__58401,G__58401__$1,already_has_ident_at_path_QMARK_,vec__58395,command,data_path,actions){
return (function (){
...
/** @this {Function} */
com.fulcrologic.fulcro.algorithms.data_targeting.integrate_ident_STAR_.cljs$lang$applyTo = (function (seq58388){
...
if(com.fulcrologic.fulcro.algorithms.data_targeting.special_target_QMARK_(target__$1)){
var G__58447 = state_map__$1;
var G__58447__$1 = ((com.fulcrologic.fulcro.algorithms.data_targeting.prepend_target_QMARK_(target__$1))?com.fulcrologic.fulcro.algorithms.data_targeting.integrate_ident_STAR_.cljs$core$IFn$_invoke$arity$variadic(G__58447,item_to_place,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"prepend","prepend",342616040),target__$1], 0)):G__58447);
var G__58447__$2 = ((com.fulcrologic.fulcro.algorithms.data_targeting.append_target_QMARK_(target__$1))?com.fulcrologic.fulcro.algorithms.data_targeting.integrate_ident_STAR_.cljs$core$IFn$_invoke$arity$variadic(G__58447__$1,item_to_place,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"append","append",-291298229),target__$1], 0)):G__58447__$1);
if(com.fulcrologic.fulcro.algorithms.data_targeting.replacement_target_QMARK_(target__$1)){
return com.fulcrologic.fulcro.algorithms.data_targeting.integrate_ident_STAR_.cljs$core$IFn$_invoke$arity$variadic(G__58447__$2,item_to_place,cljs.core.prim_seq.cljs$core$IFn$_invoke$arity$2([new cljs.core.Keyword(null,"replace","replace",-786587770),target__$1], 0));
} else {
return G__58447__$2;
}
} else {
...
var G__58453 = process_target_impl(state_map,source_path,target);
...
return cljs.core.dissoc.cljs$core$IFn$_invoke$arity$2(G__58453,source_path);
} else {
return G__58453;
}
});
