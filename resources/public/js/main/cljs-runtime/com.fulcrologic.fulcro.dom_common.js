...
return (function (p1__60318_SHARP_){
return cljs.core.re_matches(/^#.*/,p1__60318_SHARP_);
});})(tokens))
,tokens));
var classes = cljs.core.filter.cljs$core$IFn$_invoke$arity$2(((function (tokens,id){
return (function (p1__60319_SHARP_){
return cljs.core.re_matches(/^\..*/,p1__60319_SHARP_);
});})(tokens,id))
,tokens);
...
var G__60320 = new cljs.core.PersistentArrayMap(null, 1, [new cljs.core.Keyword(null,"classes","classes",2037804510),cljs.core.into.cljs$core$IFn$_invoke$arity$2(cljs.core.PersistentVector.EMPTY,cljs.core.keep.cljs$core$IFn$_invoke$arity$2(com.fulcrologic.fulcro.dom_common.remove_separators,classes))], null);
if(cljs.core.truth_(sanitized_id)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__60320,new cljs.core.Keyword(null,"id","id",-1388402092),sanitized_id);
} else {
return G__60320;
}
} else {
...
var map__60326 = com.fulcrologic.fulcro.dom_common.parse(kw);
...
var classes = cljs.core.get.cljs$core$IFn$_invoke$arity$3(map__60326__$1,new cljs.core.Keyword(null,"classes","classes",2037804510),cljs.core.PersistentVector.EMPTY);
...
var G__60331_60347 = props__$1;
var G__60332_60348 = "className";
var G__60333_60349 = com.fulcrologic.fulcro.dom_common.combined_classes(classes,existing_classes);
goog.object.set(G__60331_60347,G__60332_60348,G__60333_60349);
} else {
}
...
var G__60334 = (function (){var or__4131__auto__ = props;
...
var G__60334__$1 = ((cljs.core.seq(classes))?cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__60334,new cljs.core.Keyword(null,"className","className",-1983287057),com.fulcrologic.fulcro.dom_common.combined_classes(classes,existing_classes)):G__60334);
if(cljs.core.truth_(id)){
return cljs.core.assoc.cljs$core$IFn$_invoke$arity$3(G__60334__$1,new cljs.core.Keyword(null,"id","id",-1388402092),id);
} else {
return G__60334__$1;
}
}
